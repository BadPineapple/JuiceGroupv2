...
function initPastosNoMap(fazendaPastosNoMapa) {
	...
	for(var i=0;i<fazendaPastosNoMapa.pastos.length;i++) {
		...
		$('#conteudo').append('<pre title="'+pastoMapaVH.idPasto+'">Pasto (Nome): '+pastoMapaVH.nome+', cocho vazio: '+JSON.stringify(pastoMapaVH.cochoVazio)+'</pre>');
...
$(document).ready(function() {
	...
	var url = ENDERECO_SITE+'/ilionnet/terrafos/monitoramento/abastecimento-dos-cochos';
