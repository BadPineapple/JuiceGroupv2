...
function initPastosNoMap(fazendaPastosNoMapa) {
	...
	for(var i=0;i<fazendaPastosNoMapa.pastos.length;i++) {
		...
		$('#conteudo').append('<pre>Pasto: '+pastoMapaVH.nome+', entreveros: '+JSON.stringify(pastoMapaVH.entrevero)+'</pre>');
...
$(document).ready(function() {
	...
	var url = ENDERECO_SITE+'/ilionnet/terrafos/monitoramento/entreveros';
