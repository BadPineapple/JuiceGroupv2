                ...
                <form ng-submit="submitProfissional()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="dados-person">
                                <div class="img-person">
                                    <figure>
                                        <img id="img"
                                             src="${profissional.pessoa.foto.link == null ? '../../assets/images/perfil.png' : profissional.pessoa.foto.link}"
                                             alt="" style="height: 162px;width: 162px;">
                                    </figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" id="nome" ng-model="profissional.pessoa.nome"
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class=" form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label>Cpf</label>
                                    <input type="text" class="form-control" data-mask="000.000.000-00" id="cpf"
                                           ng-model="profissional.pessoa.cpf">
                                </div>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class=" form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label>Data Nascimento</label>
                                    <input type="text" class="form-control" data-mask="00/00/0000" id="dataAniversario"
                                           ng-model="profissional.pessoa.dataNascimento" ng-blur="">
                                </div>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label class="control-label">Situa&ccedil;&atilde;o Autoriza&ccedil;&atilde;o</label>
                                    <select ng-model="profissional.situacaoAprovacaoProfissional"
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="email" id="email" ng-model="profissional.pessoa.email"
                                           class="form-control input-group-lg" required/>
                                </div>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="password" id="senha" ng-model="profissional.pessoa.senha"
                                           class="form-control input-group-lg" required disabled="true"/>
                                </div>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label for="telefone" class="control-label">Telefone</label>
                                    <input type="Large" id="telefone" ng-model="profissional.pessoa.telefone"
                                           data-mask="(00) 00000-0000" class="form-control input-group-lg"/>
                                </div>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label for="celular" class="control-label">Celular</label>
                                    <input type="Large" id="celular" ng-model="profissional.pessoa.celular"
                                           data-mask="(00) 00000-0000" class="form-control input-group-lg"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="Large" id="cep" ng-model="profissional.pessoa.cep"
                                           data-mask="00.000-000" class="form-control input-group-lg" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <select ng-model="profissional.tipoProfissional"
                                            class="form-control input-group-lg">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <select ng-model="profissional.conselhoProfissional"
                                            class="form-control input-group-lg">
                                        <c:forEach items="${conselhoProfissional}" var="conselho">
                                            <option ng-if="profissional.tipoProfissional == 'PSICOLOGO'"
                                                    value="${conselho}">${conselho.valor} - ${conselho.CRP}</option>
                                            <option ng-if="profissional.tipoProfissional == 'MEDICO'"
                                                    value="${conselho}">${conselho.valor} - ${conselho.CRM}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" ng-model="profissional.documentoCrpCrm"
                                           class="form-control input-group-lg"/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" ng-model="profissional.cadastroEpsi"
                                           class="form-control input-group-lg"/>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input class="form-control input-group-lg" type="text" data-mask="00/00/0000"
                                           ng-model="profissional.dataValidadeEpsi" id="dataValidadeEpsi">
                                    </input>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12" style="padding-left:30px;">
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <input type="checkbox" ng-model="profissional.adolescentes" id="adolescentes"
                                           ng-checked="${profissional.adolescentes}"/>
                                    <label>adolescentes</label>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <input type="checkbox" ng-model="profissional.adultos" id="adultos"
                                           ng-checked="${profissional.adultos}"/>
                                    <label>adultos</label>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <input type="checkbox" ng-model="profissional.casais" id="casais"
                                           ng-checked="${profissional.casais}"/>
                                    <label>casais</label>
                                </div>
                            </div>
                            <div class="col-md-2 col-lg-2 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <input type="checkbox" ng-model="profissional.idosos" id="idosos"
                                           ng-checked="${profissional.idosos}"/>
                                    <label>idosos</label>
                                </div>
                            </div>
                            <div class="col-md-3 col-lg-3 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <input type="checkbox" ng-model="profissional.crianca" id="crianca"
                                           ng-checked="${profissional.crianca}"/>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                <textarea class="form-control input-group-lg" cols="20" rows="5"
                                          ng-model="profissional.biografia"
                                          placeholder="Informe aqui sua vida profissional. Procure ser mais claro possível."
                                          style="color: #A6A6A6"></textarea>
                            </div>
                        </div>
						...
						<div class="col-md-12 col-lg-12 col-sm-12">
							<div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
								<strong style="color: #1795d4;">Forma&ccedil;&atilde;o</strong>
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12">
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										<tr>
											...
											<th class="text-center">Tipo Forma&ccedil;&atilde;o</th>
											<th class="text-center">Descri&ccedil;&atilde;o Forma&ccedil;&atilde;o</th>
										</tr>
						...
						<div class="col-md-12 col-lg-12 col-sm-12">
							<div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
								<strong style="color: #1795d4;">Endere&ccedil;o</strong>
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12">
							<div class="pmd-card pmd-z-depth pmd-card-custom-view">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
                                <strong style="color: #1795d4;">Tempo de dura&ccedil;&atilde;o do atendimento</strong>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label class="control-label">Tempo de dura&ccedil;&atilde;o do atendimento</label>
                                    <select ng-model="profissional.duracaoAtendimento"
                                            class="form-control input-group-lg">
						...
						<div class="col-md-12 col-lg-12 col-sm-12">
							<div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
								<strong style="color: #1795d4;">Hor&aacute;rio Atendimento</strong>
							</div>
						</div>
						<div class="col-md-12 col-lg-12 col-sm-12">
							<div class="pmd-card pmd-z-depth pmd-card-custom-view">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" ng-model="profissional.valorConsultaOnline"
                                           id="valorconsultaOnline" class="valorMonetario form-control input-group-lg"/>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label class="control-label">Valor da consulta presencial:</label>
                                    <input type="text" ng-model="profissional.valorConsultaPresencial"
                                           id="valorConsultaPresencial"
                                           class="valorMonetario form-control input-group-lg"/>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label class="control-label">Tempo de antecendencia:</label>
                                    <select ng-model="profissional.tempoAntecendencia"
                                            class="form-control input-group-lg">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
                                <strong style="color: #1795d4;">Dados banc&aacute;rios</strong>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-4 col-lg-4 col-sm-12">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" ng-model="profissional.agencia"
                                           class="form-control input-group-lg"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" ng-model="profissional.conta"
                                           class="form-control input-group-lg"/>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label class="control-label">Conta (d&iacute;gito verificador):</label>
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input type="text" ng-model="profissional.nomeFavorecido"
                                           class="form-control input-group-lg"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
                                <strong style="color: #1795d4;">Conv&ecirc;nios</strong>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12" style="padding-left:30px;">
                            <!--                                         <div class="col-md-4 col-lg-4 col-sm-12"> -->
                            ...
                            <!--                                                 <label>atendimento para os conv?nios no valor de R$45,00</label> -->
                            <!--                                             </div> -->
                            <!--                                         </div> -->
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                <div class="checkbox">
                                    <input type="checkbox" ng-model="profissional.convenio56" id="convenio56"
                                           ng-checked="${profissional.convenio56}"/>
                                    <label>atendimento para os conv&ecirc;nios no valor de R$56,00</label>
                                </div>
                            </div>
                            <!--                                         <div class="col-md-4 col-lg-4 col-sm-12"> -->
                            <!--                                             <div class="checkbox"> -->
                            <%--                                                 <input type="checkbox" ng-model="profissional.convenio60" id="convenio60" ng-checked="${profissional.convenio60}"/> --%>
                            <!--                                                 <label>atendimento para os conv?nios no valor de R$67,00</label> -->
                            <!--                                             </div> -->
                            <!--                                         </div> -->
                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12" style="padding-left:30px;">
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="checkbox">
                                    <input type="checkbox" ng-model="profissional.pacote2com5Desconto"
                                           id="pacote2com5Desconto" ng-checked="${profissional.pacote2com5Desconto}"/>
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="checkbox">
                                    <input type="checkbox" ng-model="profissional.pacote3com10Desconto"
                                           id="pacote3com10Desconto" ng-checked="${profissional.pacote3com10Desconto}"/>
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="checkbox">
                                    <input type="checkbox" ng-model="profissional.pacote4com15Desconto"
                                           id="pacote4com15Desconto" ng-checked="${profissional.pacote4com15Desconto}"/>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
                                <strong style="color: #1795d4;">Primeira consulta cortesia/Atendimento por
                                    libras</strong>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12" style="padding-left:30px;">
                            <div class="checkbox col-md-4 col-lg-4 col-sm-12">
                                <input type="checkbox" ng-model="profissional.primeiraConsultaCortesia"
                                       id="primeiraConsultaCortesia"
                                       ng-checked="${profissional.primeiraConsultaCortesia}"/>
                                <label>primeira consulta cortesia dos novos pacientes</label>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12" style="padding-top: 6px;">
                                <label>Quantidade de consultas cortesias no m&ecirc;s:</label>
                                <input type="text" style="width: 29px;height: 24px;text-align: center;"
                                       ng-model="profissional.quantidadeConsultaCortesiaMes"/>
                            </div>
                            <div class="checkbox col-md-4 col-lg-4 col-sm-12">
                                <input type="checkbox" ng-model="profissional.atendimentoPorLibras"
                                       id="atendimentoPorLibras" ng-checked="${profissional.atendimentoPorLibras}"/>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
                                <strong style="color: #1795d4;">Aviso de f&eacute;rias/Afastamento</strong>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12 col-sm-12">
                            <div class="checkbox col-md-4 col-lg-4 col-sm-12"
                                 style="padding-top: 39px;padding-left: 32px;">
                                <input type="checkbox" ng-model="profissional.avisoFerias" id="avisoFerias"
                                       ng-checked="${profissional.avisoFerias}"/>
                                <label>Incluir data in&iacute;cio e data fim do afastamento</label>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12" id="divCampoDataInicialAviso">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    <label class="control-label">Data Inicio</label>
                                    <input class="form-control input-group-lg" type="text" data-mask="00/00/0000"
                                           ng-model="profissional.dataInicioAvisoFerias" id="dataInicioAvisoFerias"/>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-4 col-sm-12" id="divCampoFinalDataAviso">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                    ...
                                    <input class="form-control input-group-lg" type="text" data-mask="00/00/0000"
                                           ng-model="profissional.dataFimAvisoFerias" id="dataFimAvisoFerias"/>
                                </div>
                            </div>
                        </div>
						...
						<div class="col-md-12 col-lg-12 col-sm-12">
							<div class="col-md-12 col-lg-12 col-sm-12 divTitulo">
								<strong style="color: #1795d4;">Assinatura do termo de ades&atilde;o</strong>
							</div>
						</div>
						<div class="col-md-3 col-lg-3 col-sm-12">
							<div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
								<label for="cep" class="control-label">Data Aceite Contrato</label>
								<input type="Large" id="dataAceiteContrato" disabled="true"
									   ng-model="profissional.dataAceiteContrato"
									   class="form-control input-group-lg" required/>
							</div>
						</div>
						<div class="col-md-3 col-lg-3 col-sm-12">
							<div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
								...
								<input type="Large" id="ipAceiteContrato" disabled="true"
									   ng-model="profissional.ipAceiteContrato" class="form-control input-group-lg"
									   required/>
							</div>
						</div>
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12"
                            ...
                            <div class="  form-group pmd-textfield pmd-textfield-floating-label form-group-lg textfield-floating-label-completed pmd-textfield-floating-label-completed">
                                <button type="submit" class="btn btn-success pmd-checkbox-ripple-effect"><i
                                        class="fa fa-save" style="padding-right: 10px"></i>Salvar
                                </button>
                                <a href="<ilion:url/>profissional" class="btn btn-warning"><i class="fas fa-search"
