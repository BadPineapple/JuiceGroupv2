...
<link rel="shortcut icon" href="<ilion:url/>images/favicon.ico" />
<!-- jquery -->
...
<body class="atiAbaImagens">

<link type="text/css" rel="stylesheet" href="<ilion:url/>ilionnet/design/script/lytebox/lytebox.css" media="screen" />
<script type="text/javascript" src="<ilion:url/>ilionnet/design/script/lytebox/lytebox.js"></script>

<div id="wrapMenu">
	<jsp:include page="include-abas.jsp" flush="true" />
</div>
<div id="wrap">
	<jsp:include page="include-content-imagens.jsp" flush="true" />
</div>
</body>
</html>