		                ...
		                <table class="table table-bordered">
							...
							<tr>
								...
								<td class="pmd-table-row-action">
									<a href="<ilion:url/>ilionnet/terrafos/cadastros-padroes/forrageiras/${forrageira.id}/editar" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
										<i class="material-icons md-dark pmd-sm">edit</i>
									</a>
									<a href="javascript:;" onclick="if(confirm('Tem certeza?')){location='<ilion:url/>ilionnet/terrafos/cadastros-padroes/forrageiras/${forrageira.id}/excluir';}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
