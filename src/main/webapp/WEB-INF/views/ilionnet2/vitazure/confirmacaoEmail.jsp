            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-7 col-xl-7 text-center">
                        <div class="checkout">
                            <h3>Que bom te ver por aqui!</h3>
                            <p>Agora você já pode utilizar a nossa plataforma. E não se preocupe: em nossa plataforma, seu sigilo e segurança estão garantidos.</p>
                        </div>
                    </div>
