    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-xl-6 d-none d-md-block">
                <div class="buttons">
                    <a href="<ilion:url/>entrar" class="button-primary">Entrar - ${PessoaSessao.nome}</a>
                    <a href="<ilion:url/>registre-se-como-cliente" class="button-secundary">Crie sua conta</a>
                    <a href="<ilion:url/>registre-se-como-psicologo" class="button-secundary">Crie sua conta Psicologo</a>
                </div>
            </div>
        </div>
    </div>
