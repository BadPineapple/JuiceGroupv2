...
public class PermissaoNaoExisteTag extends TagSupport {

	static Logger logger = Logger.getLogger(PermissaoNaoExisteTag.class); 
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			return (possuiPermissao) ? SKIP_BODY : EVAL_BODY_INCLUDE;
