...
public class ArquivosLateralDireitaHtml {
	
	static Logger logger = Logger.getLogger(ArquivosLateralDireitaHtml.class);
	...
	private static boolean ehValido(Arquivo arquivo) {
		...
		return "lateral".equals(arquivo.getLayout());
	}
	...
	private static void _imprimir(List<Arquivo> arquivos, Appendable out) {
		...
		try {
			...
			out.append("<div class=\"img-wrap img-right\">");
